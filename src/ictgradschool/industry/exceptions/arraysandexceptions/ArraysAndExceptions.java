...
public class ArraysAndExceptions {
    ...
    public void start() {
        ...
        int index = getArrayIndexFromUser(myArray);
     ...
     * </ol>
     */
    private int getArrayIndexFromUser(int[] myArray) throws IndexTooHighException,InvalidIndexException,IndexTooLowException {
        ...
        while (true) {
            ...
            try {
                ...
                if (index < 0) {
                    throw new IndexTooLowException("Index must be a positive integer");
                } else if (index > myArray.length) {
                    throw new IndexTooHighException("Index must be < 5");
                }
                return index;
                ...
                throw new InvalidIndexException("Index must be an integer");
            }
        }
